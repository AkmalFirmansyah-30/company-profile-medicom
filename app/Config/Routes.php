...
$routes->get('/quiz/isidata', 'MainUsers::isiDataQuiz');
$routes->post('/quiz/process', 'MainUsers::startQuizProcess');
$routes->get('/quiz/pertanyaan', function() {return redirect()->to('/quiz/pertanyaan/1');});
$routes->get('/quiz/pertanyaan/(:num)', 'MainUsers::tampilkanPertanyaan/$1');
