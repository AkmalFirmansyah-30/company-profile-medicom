...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // PHP variables are checked to determine if it's the last question
    ...
    function update() {
        ...
        // Jika ini adalah soal terakhir, pastikan aksi form mengarah ke halaman hasil
        if (isLastQuestion) {
            form.action = resultUrl;
        }
    }

    // Mengganti tombol saat ini dengan yang baru sesuai kondisi
    if (isLastQuestion) {
